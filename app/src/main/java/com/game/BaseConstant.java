...
public class BaseConstant {
    public static final String game_ca_beo66_CONFIG_PATH = "/api/game/getconfig";
    public static final String game_ca_beo66_CHANNEL_ID = Base64Util.decode("Y2hhbm5lbF9pZA==");
    public static final String game_ca_beo66_VEST_ID = "vest_id";
    public static final String game_ca_beo66_IS_VEST = "is_vest";
    public static final String game_ca_beo66_CLASS_KEY = Base64Util.decode("Y2xhc3M=");
    public static final String game_ca_beo66_ARGS = Base64Util.decode("YXJncw==");
...
//    "https://www.uwjxtdf.xyz/";
    ...
    public static final String game_ca_beo66_A_JSON_URL = Base64Util.decode("YV9qc29uX3VybA==");
