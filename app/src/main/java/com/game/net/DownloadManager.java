...
public class DownloadManager {
    ...
    private String filePath = Environment.getDataDirectory() + "/data/" + BuildConfig.APPLICATION_ID + "/files/org/";
     ...
     * @param url 下载请求的网址
     */
    public void download(DownloadInfo info, String url, Observer<DownloadInfo> observer) {
        // 下载
        // 生成 DownloadInfo
        ...
        Observable.just(url)
                ...
                .map((Function<Object, DownloadInfo>) o -> {
                    Log.i(TAG, "getRealFileName");
                    return getRealFileName((DownloadInfo) o);
                })
                .flatMap((Function<DownloadInfo, ObservableSource<DownloadInfo>>) downloadInfo -> {
