...
public class AppUtil {
    ...
    public void clip2Cocos(String text) {
        ClipboardManager clipboardManager = (ClipboardManager) FishContext.getInstance().getSystemService(Context.CLIPBOARD_SERVICE);
     ...
     */
    public void quitApp() {
        ActivityManager manager = (ActivityManager) FishContext.getInstance().getApplicationContext()
                .getSystemService(Context.ACTIVITY_SERVICE);
        manager.killBackgroundProcesses(FishContext.getInstance().getApplicationContext().getPackageName());
        System.exit(0);
    }
    ...
    public void openDeepLink(String deepLink) {
        ...
        try {
            ...
            FishContext.getInstance().getApplicationContext().startActivity(intent);
    ...
    public String getTelOperator() {
        TelephonyManager telephonyManager =
                (TelephonyManager) FishContext.getInstance().getApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public long getInstallTime() {
        PackageManager packageManager = FishContext.getInstance().getApplicationContext().getPackageManager();
