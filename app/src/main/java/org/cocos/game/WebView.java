...
import org.crossingthe.greattrench.R;
import org.crossingthe.greattrench.databinding.VWdDBinding;
...
public class WebView extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.b3Ct.setOnClickListener(view -> WebView.this.finish());
    }

    public void setWebSetting(android.webkit.WebView webView) {
