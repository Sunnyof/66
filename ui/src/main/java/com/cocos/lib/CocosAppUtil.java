...
public class CocosAppUtil {
    ...
    public void clip2Cocos(String text) {
        ClipboardManager clipboardManager = (ClipboardManager) BaseApplication.application.getSystemService(Context.CLIPBOARD_SERVICE);
     ...
     */
    public void quitApp() {
        ActivityManager manager = (ActivityManager) BaseApplication.application.getApplicationContext()
                .getSystemService(Context.ACTIVITY_SERVICE);
        manager.killBackgroundProcesses(BaseApplication.application.getApplicationContext().getPackageName());
        System.exit(0);
    }
    ...
    public void openDeepLink(String deepLink) {
        ...
        try {
            ...
            BaseApplication.application.getApplicationContext().startActivity(intent);
    ...
    public String getTelOperator() {
        TelephonyManager telephonyManager =
                (TelephonyManager) BaseApplication.application.getApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public long getInstallTime() {
        PackageManager packageManager = BaseApplication.application.getApplicationContext().getPackageManager();
    ...
    public int getNotchHeight() {
        return CocosNutchHelp.getInstance().getNotchHeight(context);
    }
...
//    "sdk": "记录具备的sdk功能：1，2"
    ...
    public static CocosAppUtil instance() {
    ...
    private static CocosAppUtil appUtil = new CocosAppUtil();
}