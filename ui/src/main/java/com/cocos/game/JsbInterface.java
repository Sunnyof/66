...
public class JsbInterface {
    private static Gmodel mViewModel;

    private static String TAG = JsbInterface.class.getName();

    private static WebListener mWebViewListener;


    public void withContext(Gmodel viewModel) {
        mViewModel = viewModel;
    }

    public void setListener(WebListener webViewListener) {
...
//    <br>
    public static void openURL(String url) {
        Log.i(TAG, "openURL");
        CocosAppUtil.instance().openDeepLink(url);
...
//    <br>
    public static void setClipboard(String str) {
        Log.e(TAG, str);
        CocosAppUtil.instance().clip2Cocos(str);
    }
...
//    <br>
    public static void lockOrientation(boolean isPortrait) {
        ...
        CocosAppUtil.instance().lockOrientation(isPortrait);
    }
...
//    <br>
    public static void setKeepScreenOn(Boolean keepScreenOn) {
        ...
        CocosAppUtil.instance().keepScreenOn(keepScreenOn);
    }
